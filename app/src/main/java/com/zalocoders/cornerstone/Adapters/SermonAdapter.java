...
import com.zalocoders.cornerstone.activities.ListenSermonActivity;
import com.zalocoders.cornerstone.activities.ViewImageActivity;
...
public class SermonAdapter extends RecyclerView.Adapter<SermonAdapter.newsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull newsViewHolder holder, int position) {
        ...
        holder.description.setText(sermon.getDescription());
